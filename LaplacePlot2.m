function error = LaplacePlot2(True,Weeks,T,char,ub)
colors
...
if(Q(end)-Q(1)>1e5)&&(Q(1)>0)&&(Z(1)>0)
    ...
    print(['L',num2str(char),' ',num2str(2*ub),'_approx_v_true_Weeks'],'-djpeg')
    hold off
...
print(['L',num2str(char),' ',num2str(2*ub),'_error_Weeks'],'-djpeg')
hold off
