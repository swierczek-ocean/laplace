function [TotalError, TruncateError, RoundoffError] = wfncpuErrorEstAlphaRho(rhoP,alphaP,FLaplace,TimeInput,NLag,ErrorFlag)
%WFNCPUERRORESTALPHARHO A function to return the absolute error estimate of the approximate f(t) from the Weeks method
...
%
%  Use: 
%  [TotalError, TruncateError, RoundoffError] = wfncpuErrorEstAlphaRho(rhoP,alphaP,FLaplace,TimeInput,NLag,ErrorFlag)
%  
%  Input:
...
%The cofficients can be computed with either parameters

av = wfncpuFFTLagCoefAlphaRho(FLaplace,Ntail,alphaP,rhoP);
