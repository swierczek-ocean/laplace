...
%   options1 = optimset('TolX',tols)   
%   sigmaP = fminbnd('wfnNestedErrorSigmab',sigmin,sigmax,options1);
%   options2 = optimset('TolX',tolb)   
%   bP = fminbnd('wfncpuErrorEstSigmab',0,bmax,options2); %ErrorFlag=0->total error 
